...
import { Clock, LayoutDashboard, NotebookPen, BookOpenCheck, ListChecks, Target, Flame, LogOut } from "lucide-react";
...
const NAV = [
  ...
  { href: "/45-day-challenge", label: "45 Days Challenge", icon: Flame },
];
