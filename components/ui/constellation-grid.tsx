...
interface ConstellationGridProps {
    /** Show the "Constellation" hero title overlay. Defaults to true, matching the original demo. */
    showTitle?: boolean;
    /** Skip syncing with the OS light/dark preference and always render the dark palette. */
    forceDark?: boolean;
}

export default function ConstellationGrid({ showTitle = true, forceDark = false }: ConstellationGridProps = {}) {
