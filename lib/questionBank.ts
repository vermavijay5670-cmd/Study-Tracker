...
const REGISTRY: Record<string, () => Promise<Question[]>> = {
  ...
  phy_11_ : () => import("./question-data/phy-11-thermodynamics").then ((m) => m.default),
  phy_11_ : () => import("./question-data/phy-11-kinetic-theory-of-gases").then ((m) => m.default),
  phy_11_ : () => import("./question-data/phy-11-oscillation").then ((m) => m.default),
  phy_11_ : () => import("./question-data/phy-11-waves").then ((m) => m.default),
