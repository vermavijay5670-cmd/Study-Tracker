...
const REGISTRY: Record<string, () => Promise<Question[]>> = {
  ...
  phy_11_5: () => import("./question-data/phy-11-system-of-particle-an-rotation-motion").then ((m) => m.default),
  phy_11_6: () => import("./question-data/phy-11-gravitation").then ((m) => m.default),
  phy_11_7: () => import("./question-data/phy-11-mechanical-properties-of-solids").then ((m) => m.default),
  phy_11_8: () => import("./question-data/phy-11-mechanical-properties-of-fluids").then ((m) => m.default),
  phy_11_9: () => import("./question-data/phy-11-thermal-properties-of-matter").then ((m) => m.default),
  phy_11_10: () => import("./question-data/phy-11-thermodynamics").then ((m) => m.default),
  phy_11_11: () => import("./question-data/phy-11-kinetic-theory-of-gases").then ((m) => m.default),
  phy_11_12: () => import("./question-data/phy-11-oscillation").then ((m) => m.default),
  phy_11_13: () => import("./question-data/phy-11-waves").then ((m) => m.default),
  ...
  chem_11_5: () => import("./question-data/chem-11-equilibrium").then ((m) => m.default),
  chem_11_6: () => import("./question-data/chem-11-redox-reaction").then((m) => m.default),
